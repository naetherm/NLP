...
"""
Got that from: https://github.com/barronalex/Dynamic-Memory-Networks-in-TensorFlow/blob/master/attention_gru_cell.py
"""
...
class AttentionGRUCell(RNNCell):
    ...
    def __init__(self, num_units, input_size=None, activation=tanh, name="gru"):
        super(AttentionGRUCell, self).__init__(name=name)
...
def _linear(args, output_size, bias, bias_start=0.0):
    ...
    with vs.variable_scope(scope, reuse=tensorflow.compat.v1.AUTO_REUSE) as outer_scope:
